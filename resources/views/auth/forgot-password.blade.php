...
<head>
    ...
    <title>Forgot Password — MASSIVE</title>
    ...
    <div class="w-full max-w-md animate-scale-in">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-1">Masukkan kata sandi baru untuk akun Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('forgot-password') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="form-input form-input-icon" placeholder="Email terdaftar Anda" required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" class="form-input form-input-icon pr-11" placeholder="Masukkan kata sandi baru" required>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-input form-input-icon pr-11" placeholder="Ulangi kata sandi baru" required>
                ...
                <button type="submit" class="btn-primary w-full py-3 text-base rounded-xl">Simpan Kata Sandi Baru</button>
            </form>

            <p class="text-center text-sm text-gray-500 mt-6">
                <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-700 font-semibold">← Kembali ke Halaman Masuk</a>
            </p>
        </div>
    </div>
    <script>
